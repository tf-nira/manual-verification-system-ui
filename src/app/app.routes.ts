...
import { MvsAdminVerificationComponent } from './feature/mvs-admin-verification/mvs-admin-verification.component';
...
export const routes: Routes = [
  ...
  { path: 'mvs-admin-verification', component: MvsAdminVerificationComponent, canActivate: [AuthGuard] },
